...
/**
 * Created by NghiaNH on 11/10/2016.
 */
...
import com.nghianh.giaitriviet.util.RSSDatabaseHandler;
    ...
    class loadRSSFeed extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                com.nghianh.giaitriviet.util.Log.printStackTrace(e);
            ...
            if (rssFeed != null) {
                ...
                WebSite site = new WebSite(rssFeed.getTitle(), rssFeed.getLink(), rssFeed.getLink(),
                        rssFeed.getDescription());
                rssDb.addSite(site);
                Intent i = getIntent();
